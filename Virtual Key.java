...
class operation
{
	...
	static void addFile() throws Exception //starts of addFile method
	{
		...
		String filepath="D:\\Lockers\\"+filename;
	...
	static void deleteFile() throws Exception //starts of deleteFile method
	{
		...
		File f=new File("D:\\Lockers\\"+filename);
		if(f.delete())
		{
...
public class FileManager extends operation{
	static Scanner sc=new Scanner(System.in);
	...
	private static void mydetails() 
	{
		...
		System.out.println("My Name is Dipak Sinh");
		System.out.println("My Project name is LockedMe.com");
		System.out.println("My mail id is singhdk.singh68@gmail.com\n=========================================\n");
